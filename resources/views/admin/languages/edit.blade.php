    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.languages.update", [$language->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_ar') ? 'is-invalid' : '' }}" type="text" name="name_ar" id="name_ar" value="{{ old('name_ar', $language->name_ar) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name_en') ? 'is-invalid' : '' }}" type="text" name="name_en" id="name_en" value="{{ old('name_en', $language->name_en) }}" required>
...
<script>
    ...
    url: '{{ route('admin.languages.storeMedia') }}',
    maxFilesize: 2, // MB
...
@if(isset($language) && $language->icon)
      var file = {!! json_encode($language->icon) !!}
