    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.guides.update", [$guide->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $guide->user->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" type="text" name="last_name" id="last_name" value="{{ old('last_name', $guide->user->last_name) }}" required>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $guide->user->email) }}" required>
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $guide->user->phone) }}" required>
                @if($errors->has('phone'))
                    <div class="invalid-feedback">
                        {{ $errors->first('phone') }}
                    </div>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('country') ? 'is-invalid' : '' }}" type="text" name="country" id="country" value="{{ old('country', $guide->user->country) }}" required>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('city') ? 'is-invalid' : '' }}" type="text" name="city" id="city" value="{{ old('city', $guide->user->city) }}" required>
                @if($errors->has('city'))
                    <div class="invalid-feedback">
                        {{ $errors->first('city') }}
                    </div>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control date {{ $errors->has('dob') ? 'is-invalid' : '' }}" type="text" name="dob" id="dob" value="{{ old('dob', $guide->user->dob) }}" required>
                @if($errors->has('dob'))
                    <div class="invalid-feedback">
                        {{ $errors->first('dob') }}
                    </div>
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-control select2 {{ $errors->has('naitev_language') ? 'is-invalid' : '' }}" name="naitev_language_id" id="naitev_language_id" required>
                    @foreach($naitev_languages as $id => $entry)
                        <option value="{{ $id }}" {{ (old('naitev_language_id') ? old('naitev_language_id') : $guide->user->naitev_language->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-md-6">
                ...
                <select class="form-control select2 {{ $errors->has('speaking_languages') ? 'is-invalid' : '' }}" name="speaking_languages[]" id="speaking_languages" multiple required>
                    @foreach($speaking_languages as $id => $speaking_language)
                        <option value="{{ $id }}" {{ (in_array($id, old('speaking_languages', [])) || $guide->user->speaking_languages->contains($id)) ? 'selected' : '' }}>{{ $speaking_language }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group col-md-6">
                ...
                <textarea class="form-control {{ $errors->has('brief_intro') ? 'is-invalid' : '' }}" name="brief_intro" id="brief_intro" required>{{ old('brief_intro', $guide->brief_intro) }}</textarea>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('major') ? 'is-invalid' : '' }}" type="text" name="major" id="major" value="{{ old('major', $guide->major) }}" required>
                @if($errors->has('major'))
                    <div class="invalid-feedback">
                        {{ $errors->first('major') }}
                    </div>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('cost') ? 'is-invalid' : '' }}" type="number" name="cost" id="cost" value="{{ old('cost', $guide->cost) }}" step="0.01" required>
                @if($errors->has('cost'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cost') }}
                    </div>
