    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.tourists.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.tourist.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.tourist.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-Tourist">
                <thead>
                    <tr>
                        <th width="10">
...
@can('tourist_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.tourists.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-Tourist:not(.ajaxTable)').DataTable({ buttons: dtButtons })
