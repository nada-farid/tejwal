...
@section('content')
@can('following_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.followings.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.following.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-Following">
                <thead>
                    <tr>
                        <th width="10">
...
@can('following_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.followings.massDestroy') }}",
...
@endcan
  ...
  let table = $('.datatable-Following:not(.ajaxTable)').DataTable({ buttons: dtButtons })
